...
namespace Hangfire.SQLite
{
    public class SQLiteStorage : JobStorage
    {
        ...
        public SQLiteStorage([NotNull] IDbConnection existingConnection)
        {
        ...
        {
            return new SQLiteMonitoringApi(_connectionString, QueueProviders);
        }
        ...
        {
            var defaultQueueProvider = new SQLiteJobQueueProvider(_options);
